<template>
    <app-layout title="Edit Pembayayan SPP">
            ...
            <div>
                <nav aria-label="breadcrumb">
                    <ol class="flex leading-none text-indigo-600 divide-x divide-indigo-400">
                        ...
                        <li class="px-4"><Link :href="route('spps.index')" >Angkatan</Link></li>
                        <li class="px-4 text-gray-700" aria-current="page">Edit Pembayayan SPP</li>
                    </ol>
                </nav>
            </div>
            <div></div>
...
<script>
    ...
    export default defineComponent({
        ...
        methods: {
            updateSpp() {
                this.form.post(route('spps.update', this.itemId), {
                    errorBag: 'updateSpp',
                    preserveScroll: true,
                    onSuccess: page => {
                        //console.log(page)
            ...
            getStudent(value) {
                ...
                this.form.amount = value?.student?.room?.price
            }
        },
        computed: {
            setYear: function () {

<template>
    <app-layout title="Bayar Daftar Ulang">
                ...
                <div>
                    <nav aria-label="breadcrumb">
                        <ol class="flex leading-none text-indigo-600 divide-x divide-indigo-400">
                            ...
                            <li class="px-4 text-gray-700" aria-current="page">Bayar Daftar Ulang</li>
                        </ol>
                    </nav>
                </div>
                <div></div>
        ...
        <div>
            <div class="max-w-full mx-auto py-10">
                <jet-form @submitted="createRegistration">
                    <template #form>
...
<script>
    ...
    export default defineComponent({
        ...
        methods: {
            createRegistration() {
                this.form.post(route('registrations.store'), {
                    errorBag: 'createRegistration',
                    preserveScroll: true,
                    onSuccess: page => {
                        //console.log(page)
                    },
